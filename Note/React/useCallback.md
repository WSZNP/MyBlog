...
1. useCallback 返回当前所缓存的函数，useMemo 返回函数执行的结果。
2. useCallback 适合去缓存函数，而 useMemo 适合去缓存函数的执行结果。
...
![](/assets/images/React/useCallback/1.png)
...
![](/assets/images/React/useCallback/2.png)
...
![](/assets/images/React/useCallback/3.png)
