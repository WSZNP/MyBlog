...
因为`vite`默认是从根目录找`index.html`文件，但是我们的项目结构是`example/index.html`，所以需要配置`vite.config.ts`
...
![](/assets/images/React/组件实战/1.png)
...
![](/assets/images/React/组件实战/2.png)

## 发布 Npm

1. 没有账号可以注册一个 `npm adduser` [npm 官网](https://www.npmjs.com/)
2. 登录 `npm login` 输入账号密码
3. 发布 `npm publish` 发布成功后，就可以在 npm 官网搜索到你的包了

![](/assets/images/React/组件实战/3.png)
...
![](/assets/images/React/组件实战/4.png)
