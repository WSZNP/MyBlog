...
![image-20231206195737853](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206195737853.png) 

![image-20231206195805424](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206195805424.png) 
...
![image-20231206195929770](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206195929770.png) 
...
![image-20231206200307130](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206200307130.png) 
...
发起POST请求，访问：http://localhost:8080/login
 ...
 ![image-20231206201208501](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201208501.png) 

Apifox 测试通过了，那接下来，我们就可以结合着前端工程进行联调测试。

先退出系统，进入到登录页面。在登录页面输入账户密码：

![image-20231206201242992](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201242992.png) 



登录成功之后进入到后台管理系统页面：

![image-20231206201308629](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201308629.png) 
...
![image-20231206201444475](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201444475.png) 
...
![image-20231206201504022](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201504022.png) 
...
![image-20231206201522286](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201522286.png) 
...
![image-20231206201725682](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201725682.png) 
...
服务器端在给客户端在响应数据的时候，会**自动**的将 cookie 响应给浏览器，浏览器接收到响应回来的 cookie 之后，会**自动**的将 cookie 的值存储在浏览器本地。接下来在后续的每一次请求当中，都会将浏览器本地所存储的 cookie **自动**地携带到服务端。
 ...
 ![image-20231206201808926](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201808926.png) 
...
- 请求头 Cookie：携带Cookie数据的
 ...
 ![image-20231206201829612](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206201829612.png) 
...
![image-20231206202141563](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202141563.png)  

我们可以看到，设置的cookie，通过**响应头Set-Cookie**响应给浏览器，并且浏览器会将Cookie，存储在浏览器端。

![image-20231206202202289](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202202289.png)  



B. 访问c2接口 `http://localhost:8080/c2`，此时浏览器会自动的将Cookie携带到服务端，是通过**请求头Cookie**，携带的。

![image-20231206202226903](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202226903.png)  
...
> 跨域介绍：
>
> ​	 <img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202252366.png" alt="image-20231206202252366" style="zoom:80%;" />  
>
...
- 获取Session
	...
	![image-20231206202323468](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202323468.png)  
...
- 响应Cookie (JSESSIONID)
	...
	![image-20231206202344097](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202344097.png)  
...
- 查找Session
	...
	![image-20231206202401355](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202401355.png)  
...
![image-20231206202418343](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202418343.png)  
...
![image-20231206202443134](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202443134.png)  
...
![image-20231206202457719](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202457719.png)  
...
>
> ​	![image-20231206202656811](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202656811.png)  
>
> - 首先第一点，我们现在所开发的项目，一般都不会只部署在一台服务器上，因为一台服务器会存在一个很大的问题，就是单点故障。所谓单点故障，指的就是一旦这台服务器挂了，整个应用都没法访问了。
>
> ​    <img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202707034.png" alt="image-20231206202707034" style="zoom:80%;" />  
>
...
>
>   ![image-20231206202725954](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202725954.png)  
>
...
![image-20231206202748517](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202748517.png)  
...
![image-20231206202817344](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202817344.png) 
...
![image-20231206202855824](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202855824.png)  
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206202918636.png" alt="image-20231206202918636" style="zoom:67%;" /> 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206203139493.png" alt="image-20231206203139493" style="zoom:80%;" /> 
...
1. 引入JWT工具类
	 - 在项目工程下创建 `com.itheima.util` 包，并把提供JWT工具类复制到该包下
...
**完善 `EmpServiceImpl` 中的 `login` 方法逻辑， 登录成功，生成JWT令牌并返回**
...
![image-20231206203744569](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206203744569.png) 

打开浏览器完成前后端联调操作：利用开发者工具，抓取一下网络请求

![image-20231206203833994](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206203833994.png) 
...
![image-20231206204007150](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204007150.png) 



我们在发起一个查询部门数据的请求，此时我们可以看到在请求头中包含一个token(JWT令牌)，后续的每一次请求当中，都会将这个令牌携带到服务端。

![image-20231206204038634](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204038634.png) 
...
![image-20231206204210259](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204210259.png) 
...
![image-20231206204603283](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204603283.png) 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204641762.png" alt="image-20231206204641762" style="zoom:80%;" /> 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204715139.png" alt="image-20231206204715139" style="zoom: 67%;" /> 
...
![image-20231206204819253](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204819253.png) 
...
![image-20231206204846071](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204846071.png) 
...
![image-20231206204929887](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204929887.png) 
...
![image-20231206204942812](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206204942812.png) 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205000588.png" alt="image-20231206205000588" style="zoom:80%;" /> 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205040993.png" alt="image-20231206205040993" style="zoom:67%;" />  
...
- 测试1：未登录是否可以访问部门管理页面
	...
	![image-20231206205529268](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205529268.png) 
...
- 测试2：先进行登录操作，再访问部门管理页面
	...
	![image-20231206205558584](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205558584.png) 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205632864.png" alt="image-20231206205632864" style="zoom:80%;" /> 
...
![image-20231206205911539](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205911539.png)

<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206205923209.png" alt="image-20231206205923209" style="zoom:80%;" /> 
...
![image-20231206210118372](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206210118372.png) 
...
<img src="/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206210232299.png" alt="image-20231206210232299" style="zoom:80%;" /> 
...
- 测试1：未登录是否可以访问部门管理页面
	...
	![image-20231206210707587](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206210707587.png) 
...
- 测试2：先进行登录操作，再访问部门管理页面
	...
	![image-20231206210729398](/assets/images/Java/JavaWeb/后端Web实战(登录认证)/image-20231206210729398.png) 
