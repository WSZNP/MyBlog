...
>
> 是一个分布式的数据库 负责将输入的域名与对应的 IP 地址进行匹配 解析
...
![](/assets/images/Java/网络编程/网络五层模型.png)

![](/assets/images/Java/网络编程/七层模型.png)

### 5. TCP 协议数据传输

> TCP 协议：面向连接的 安全的 可靠的传输协议
...
![](/assets/images/Java/网络编程/三次握手.png)

> TCP 协议的四次挥手：
>
> ​ 第一次：客户端向服务器发送断开连接请求
>
> ​ 第二次：服务器向客服端响应收到断开连接请求(因为 TCP 连接是双向的，所以此时服务器依然可以 向客户端发送信息)
>
> ​ 第三次：客户端等待服务器发送信息完成，向服务器确定全部信息发送完毕，并且断开客户端与服务器的连接
>
> ​ 第四次：服务器向客户端断开连接

![](/assets/images/Java/网络编程/四次挥手.png)
