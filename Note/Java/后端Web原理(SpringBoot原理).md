...
![image-20231209152458716](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152458716.png)

> properties、yaml、yml三种配置文件，优先级最高的是properties

- yaml、yml两种配置文件同时存在

![image-20231209152515880](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152515880.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152530258.png" alt="image-20231209152530258" style="zoom:80%;" />

<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152546028.png" alt="image-20231209152546028" style="zoom:80%;" />

重启服务，同时配置Tomcat端口(三种配置文件、系统属性、命令行参数)，测试哪个Tomcat端口号生效：

![image-20231209152610898](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152610898.png)

删除命令行参数配置，重启SpringBoot服务：

![image-20231209152648126](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152648126.png)
...
![image-20231209152729738](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152729738.png)

![image-20231209152744508](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152744508.png)

运行jar程序：

- 同时设置Java系统属性和命令行参数

![image-20231209152804352](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152804352.png)

- 仅设置Java系统属性

![image-20231209152818800](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209152818800.png)
...
![image-20231209153243408](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153243408.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153314797.png" alt="image-20231209153314797" style="zoom:67%;" />
...
![image-20231209153351442](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153351442.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153414725.png" alt="image-20231209153414725" style="zoom: 67%;" />
...
![image-20231209153504876](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153504876.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153542669.png" alt="image-20231209153542669" style="zoom: 67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153651445.png" alt="image-20231209153651445" style="zoom:80%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153711331.png" alt="image-20231209153711331" style="zoom:80%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153744656.png" alt="image-20231209153744656" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153806869.png" alt="image-20231209153806869" style="zoom:80%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153835161.png" alt="image-20231209153835161" style="zoom:67%;" />

![image-20231209153851728](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153851728.png)

![image-20231209153904897](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153904897.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209153933968.png" alt="image-20231209153933968" style="zoom:67%;" />

> 所以配置类最终也是SpringIOC容器当中的一个bean对象

在IOC容器中除了我们自己定义的bean以外，还有很多配置类，这些配置类都是SpringBoot在启动的时候加载进来的配置类。这些配置类加载进来之后，它也会生成很多的bean对象。

<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154004276.png" alt="image-20231209154004276" style="zoom:80%;" />
...
![image-20231209154037719](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154037719.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154306593.png" alt="image-20231209154306593" style="zoom:80%;" />
...
![image-20231209154331754](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154331754.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154356704.png" alt="image-20231209154356704" style="zoom:67%;" />
...
- 导入形式主要有以下几种：1. 导入普通类 2. 导入配置类 3. 导入ImportSelector接口实现类
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154417789.png" alt="image-20231209154417789" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154437015.png" alt="image-20231209154437015" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154455707.png" alt="image-20231209154455707" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154511612.png" alt="image-20231209154511612" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154525440.png" alt="image-20231209154525440" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154541501.png" alt="image-20231209154541501" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154556441.png" alt="image-20231209154556441" style="zoom:67%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154607723.png" alt="image-20231209154607723" style="zoom:67%;" />

使用@Import注解，导入了实现ImportSelector接口的实现类。

AutoConfigurationImportSelector类是ImportSelector接口的实现类。

![image-20231209154714666](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154714666.png)

AutoConfigurationImportSelector类中重写了ImportSelector接口的selectImports()方法：

![image-20231209154725442](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154725442.png)

> selectImports()方法底层调用getAutoConfigurationEntry()方法，获取可自动配置的配置类信息集合

![image-20231209154737275](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154737275.png)

> getAutoConfigurationEntry()方法通过调用getCandidateConfigurations(annotationMetadata, attributes)方法获取在配置文件中配置的所有自动配置类的集合

![image-20231209154819984](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154819984.png)
...
- 通常在引入的起步依赖中，都有包含以上文件 ![image-20231209154930466](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154930466.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209154949427.png" alt="image-20231209154949427" style="zoom:80%;" />

第三方依赖中提供的`GsonAutoConfiguration`类：

<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155008853.png" alt="image-20231209155008853" style="zoom:80%;" />

在`GsonAutoConfiguration`类上，添加了注解`@AutoConfiguration`，通过查看源码，可以明确：`GsonAutoConfiguration` 类是一个配置。

<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155036676.png" alt="image-20231209155036676" style="zoom:80%;" />
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155255952.png" alt="image-20231209155255952" style="zoom:80%;" />
...
![image-20231209155333096](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155333096.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155404651.png" alt="image-20231209155404651" style="zoom:80%;" />
...
![image-20231209155455977](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155455977.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155517197.png" alt="image-20231209155517197" style="zoom:80%;" />
...
![image-20231209155540270](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155540270.png)
...
<img src="/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155605756.png" alt="image-20231209155605756" style="zoom:70%;" />

最后再给大家梳理一下自动配置原理：

![image-20231209155932791](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209155932791.png)
...
![image-20231209173455376](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209173455376.png)
...
![image-20231209173508551](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209173508551.png)
...
![image-20231209173525053](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209173525053.png)
...
![image-20231209173542321](/assets/images/Java/JavaWeb/后端Web原理(SpringBoot原理)/image-20231209173542321.png)
